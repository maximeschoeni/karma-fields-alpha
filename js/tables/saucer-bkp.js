...
KarmaFieldsAlpha.field.saucer = class extends KarmaFieldsAlpha.field {
  ...
  //   //
  //   //   const solution = wish.problem();
  //   //
  //   //   if (solution) {
  //   //
  //   //     this.wishes.get(wish)(solution);
  //   //
  //   //     this.wishes.delete();
  //   //
  //   //   }
  ...
  //     this.wishes.push({
  //       problem: problem,
  //       solution: solution => resolve(solution)
  //     });
  //
  //   });
  //
  ...
  //       resolve: async task => {
  //         this.userData = await KarmaFieldsAlpha.Database.State.get() || {};
  //       }
  //     });
  //
  //   }
  //
  //   return this.userData || KarmaFieldsAlpha.loading;
  // }
  //
  //
  //
  ...
  //   if (userData) {
  //
  //     const historyIndex = userData.historyIndex;
  //
  //     if (this.state) {
  //
  //       return this.state;
  ...
  //       KarmaFieldsAlpha.tasks.push({
  //         resolve: async task => {
  //           this.state = await KarmaFieldsAlpha.Database.History.get(index) || {};
  //         }
  //       });
  //
  //     }
  ...
  //   if (state) {
  //
  //     return state.layers && state.layers[index] || {};
  //
  //   }
  //
  // }
  ...
  //   if (state) {
  //
  //     return this.getLayer(state.layerIndex || 0);
  //
  //   }
  //
  // }
  ...
  //   const layer = this.getLayer();
  //
  //   if (layer !== KarmaFieldsAlpha.loading) {
  //
  //     return layer.items;
  //
  //   }
  ...
  count() {
    ...
    if (grid) {
      ...
      return grid.getCount() || KarmaFieldsAlpha.loading;
  ...
  isLastPage() {
    ...
    if (numPage === KarmaFieldsAlpha.loading) {

      return KarmaFieldsAlpha.loading;

    }

    return this.getPage() === numPage;
  }
...
KarmaFieldsAlpha.field.saucer.board = class extends KarmaFieldsAlpha.field {
  ...
  getChild(index) {
    ...
    if (this.resource.tables[index]) {

      return this.createChild({type: "table", ...this.resource.tables[index], index: index});
...
KarmaFieldsAlpha.field.saucer.table = class extends KarmaFieldsAlpha.field {
  ...
  getChild(index) {
    ...
    return this.createChild({...this.resource[index], index: index});
