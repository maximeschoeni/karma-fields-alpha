...
KarmaFieldsAlpha.MotionTracker = class {
  ...
  //       this.firstTarget = event.target;
	...
	init() {
		...
		this.originClientX = this.clientX;
		this.originClientY = this.clientY;
	...
	update() {
		...
		this.diffX = this.clientX - this.originClientX + diffScrollX;
		this.diffY = this.clientY - this.originClientY + diffScrollY;
