(function () {
	tinymce.PluginManager.add( 'placeholder', function ( editor ) {
		...
		var Label = function () {
			...
			this.contentAreaContainer = editor.getElement();
		...
		Label.prototype.check = function () {
			...
			var attrs = {id: 'mce-placeholder-plugin-label', style: {position: 'absolute', top: '67px', left: 0, color: '#888', padding: '9px 10px', width: '98%', overflow: 'hidden', display: 'none' }};
			this.el = tinymce.DOM.add( this.contentAreaContainer, "label", attrs, this.text );
