...
KarmaFieldsAlpha.fields.table = class extends KarmaFieldsAlpha.fields.field {
  ...
  async import(data) { // expect json array
  ...
  static interface = class extends KarmaFieldsAlpha.fields.field {
    ...
    async exportRow(id) {
      ...
      const object = await rowField.export();
  ...
  static controls = class extends KarmaFieldsAlpha.fields.group {
    ...
    static save = {
      ...
      title: "Save",
      // disabled: "!modified",
      disabled: ["!", ["dispatch", "modified", "boolean"]],
      primary: true
    }
      ...
      title: "Delete",
      // disabled: "!selection"
      disabled: ["!", ["dispatch", "string", "selection"]]
    }
      ...
      dashicon: "undo",
      // disabled: "!undo"
      disabled: ["!", ["dispatch", "undo", "boolean"]]
    }
      ...
      dashicon: "redo",
      // disabled: "!redo"
      disabled: ["!", ["dispatch", "redo", "boolean"]]
    }
    ...
    static insert = {
      ...
      primary: true,
      title: "Insert",
      disabled: ["!", ["dispatch", "selection", "object"]],
  ...
  static header = class extends KarmaFieldsAlpha.fields.group {
    ...
    static count = {
      ...
      value: ["replace", "# elements", "#", ["dispatch", "count", "string"]],
      dynamic: true
    }
    ...
    static pagination = class extends KarmaFieldsAlpha.fields.group {
      ...
      constructor(resource) {
        ...
        const defaultResource = {
          ...
          // hidden: "numpage=1",
          hidden: ["==", ["dispatch", "numpage", "number"], 1],
          children: [
            "firstpage",
            "prevpage",
            "currentpage",
      ...
      static firstpage = {
        ...
        text: "«",
        // disabled: "page=1",
        disabled: ["==", ["dispatch", "page", "number"], 1],
        // hidden: "numpage=1"
      }
      ...
      static currentpage = {
        ...
        // value: "{{page}} / {{numpage}}",
        value: ["replace", "# / #", "#", ["dispatch", "page", "string"], ["dispatch", "numpage", "string"]],
        // hidden: "numpage=1",
        // dynamic: true
      }
        ...
        title: "Next Page",
        text: "›",
        disabled: ["dispatch", "lastpage", "boolean"],
      }
