...
Class Karma_Fields_Alpha {
	...
	public function __construct() {
		...
		if (is_admin()) {
			...
			add_action('karma_fields_post_field', array($this, 'print_post_field'));
		...
		public function enqueue_styles() {
			...
			if (false && file_exists($plugin_path.'/js/all.min.js')) {
				...
				wp_enqueue_script('karma-field-form', $plugin_url . '/js/fields/form.js', array('karma-fields-media'), $this->version, true);
				...
				wp_enqueue_script('karma-manager-form', $plugin_url . '/js/managers/form.js', array('karma-fields-media'), $this->version, true);
	 ...
	 */
	public function print_post_field($args) {
		static $index = 0;

		$index++;

		include plugin_dir_path(__FILE__) . 'includes/post-fields.php';
